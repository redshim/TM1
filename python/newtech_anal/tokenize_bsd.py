...
k1_data = read_data('/home/6546788/Crawler_N/export/K0000004.csv')
...
import nltk
text = nltk.Text(tokens_fin, name='BSD Problem')
...
f = io.open('word_count_bsd.csv','w',encoding='utf-8')
for t in text.vocab().most_common(500):
        f.write(t[0]+','+str(t[1]/50.0000)+'\n')
f.close
