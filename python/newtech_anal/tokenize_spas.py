...
k1_data = read_data('/home/6546788/Crawler_N/export/K0000003.csv')
...
import nltk
text = nltk.Text(tokens_fin, name='SPAS Problem')
...
f = io.open('word_count_spas.csv','w',encoding='utf-8')
for t in text.vocab().most_common(500):
        f.write(t[0]+','+str(t[1]/40.0000)+'\n')
f.close
