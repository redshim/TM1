...
#page address
html_nodes(board, 'ul.basic1\  li dl dd a') %>% html_attr("href")


cafe_url = 'http://cafe.naver.com/wnd1tkghl/886379'

read_html(cafe_url,encoding="UTF-8")
